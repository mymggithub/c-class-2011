...
//assignment information:	Assignment 010v3.0
//program documentation:	5/14/2012
...
{	
	...
	do
	{
		for (i = 0 ;i < size; i++)
		{	
			cout << "In memory # " << i+1 << " is :" << "\t" << fixed << setprecision(2) << setw(10) << left << showpoint << array.getNumInArray(i) << endl;
		}
	...
	cout << endl
		  << endl
		  << "Highest # " << fixed << setprecision(2) << setw(10) << left << showpoint << High << endl
		  << "Lowest # "  << fixed << setprecision(2) << setw(10) << left << showpoint << Low << endl
		  << "Average # " << fixed << setprecision(2) << setw(10) << left << showpoint << Ave << endl;
	cout << endl
